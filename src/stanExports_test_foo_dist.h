...
namespace model_test_foo_dist_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_test_foo_dist");
    reader.add_event(38, 36, "end", "model_test_foo_dist");
    return reader;
}
...
class model_test_foo_dist
  : public stan::model::model_base_crtp<model_test_foo_dist> {
private:
        double y_dat;
        double mu_dat;
        int type;
public:
    model_test_foo_dist(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_test_foo_dist_namespace::model_test_foo_dist";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_eq(type, 0))) {
                ...
                lp_accum__.add(foo_dist_lpdf<propto__>(y_dat, mu_dat, pstream__));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_test_foo_dist_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_test_foo_dist_namespace::model_test_foo_dist stan_model;
#ifndef USING_R
